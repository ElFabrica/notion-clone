...
const DROPZONE_VARIANTS = {
  base: "relative rounded-md p-4 flex justify-center items-center flex-col cursor-pointer min-h-37.5 min-w-50 border-2 border-dashed border-muted-foreground transition-colors duration-200 ease-in-out",
